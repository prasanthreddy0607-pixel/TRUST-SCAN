    ...
    <div className="glass-panel p-5 space-y-4">
      <div className="flex items-center justify-between border-b border-slate-200 dark:border-slate-800 pb-3">
        <div className="flex items-center gap-2">
          <ScanSearch className="w-4 h-4 text-[#34A99D]" />
          <h3 className="font-bold text-slate-800 dark:text-slate-100 text-sm tracking-wide">Forensic Image Tampering Analysis</h3>
        </div>
          ...
          return (
            <div
              ...
              className={`p-3 rounded-lg border text-xs flex items-start justify-between gap-3 ${
                isSuspicious
                  ? 'bg-amber-100/70 dark:bg-amber-500/10 border-amber-300 dark:border-amber-500/20 text-slate-800 dark:text-slate-200'
                  : 'bg-slate-50 dark:bg-navy-950/40 border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-400'
              }`}
            >
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-slate-600 dark:text-slate-400 text-xs mt-0.5 font-sans leading-relaxed">{f.explanation}</p>
                </div>
              </div>
