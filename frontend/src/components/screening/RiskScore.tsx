    ...
    <div className="glass-panel p-6 space-y-6">
      <div className="flex items-center justify-between border-b border-slate-800 pb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-bold text-slate-100 text-base tracking-wide">Screening Risk Score</h3>
            <p className="text-xs text-slate-400">Automated multi-engine risk evaluation</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-3 gap-4 text-center bg-navy-950/60 p-4 rounded-xl border border-slate-800/80">
        <div>
          ...
          <p className="text-3xl font-extrabold mt-1 font-mono" style={{ color }}>
            {risk_score}<span className="text-sm text-slate-500 font-normal">/100</span>
          </p>
        </div>
        <div>
          <p className="text-[11px] font-mono text-slate-400 uppercase">Analysis Confidence</p>
          <p className="text-2xl font-bold text-slate-100 mt-1.5 font-mono">
            {Math.round(confidence * 100)}%
          </p>
        </div>
        <div>
          <p className="text-[11px] font-mono text-slate-400 uppercase">Recommendation</p>
          <p className="text-xs font-semibold text-slate-200 mt-2 font-mono uppercase bg-slate-800/80 px-2 py-1 rounded border border-slate-700 truncate">
              ...
              return (
                <div key={key} className="space-y-1">
                  <div className="flex justify-between font-mono text-[11px]">
                    ...
                    <span className="text-slate-400 font-bold">{val} / 100</span>
                  </div>
